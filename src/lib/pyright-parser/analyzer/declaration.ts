...
export function isParameterDeclaration(
  decl: Declaration
): decl is ParameterDeclaration {
  return decl.type === DeclarationType.Parameter;
}

export function isTypeParameterDeclaration(
  decl: Declaration
): decl is TypeParameterDeclaration {
...
export function isAliasDeclaration(
  decl: Declaration
): decl is AliasDeclaration {
  return decl.type === DeclarationType.Alias;
}

export function isSpecialBuiltInClassDeclaration(
  decl: Declaration
): decl is SpecialBuiltInClassDeclaration {
  return decl.type === DeclarationType.SpecialBuiltInClass;
}

export function isIntrinsicDeclaration(
  decl: Declaration
): decl is IntrinsicDeclaration {
