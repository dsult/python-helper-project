...
export class TimingStat {
  ...
  timeOperation<T extends (...args: any[]) => any>(
    callback: T,
    ...args: any[]
  ): ReturnType<T> {
    this.callCount++;
